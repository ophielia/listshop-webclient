...
export interface ILegacyIngredient {
...
export class LegacyIngredient implements ILegacyIngredient {
  constructor() {
  }
  ...
  static clone(ingredient: ILegacyIngredient) {
    var newIngredient = new LegacyIngredient();
