...
## [2.6.1] March 2025
### Added
- full ingredient entry, adding dish

### Fixed
- dish search bug
- fixing small issues with ingredient entry, and showing ingredients

## [2.6.0] July 2024
### Added
- ability to add amounts to dishes
- components with auto suggest for amounts
### Changed
